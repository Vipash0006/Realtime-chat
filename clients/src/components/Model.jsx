          ...
          >
            <Box sx={style}>
              ...
              <div>
                ...
                <div>
                  <form className='mt-5 flex flex-col gap-y-3' onSubmit={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                    return false;
                  }}>
                  ...
                  <div className='flex justify-end gap-x-3 mt-3'>
                    <button type="button" onClick={(e) => {
                      e.preventDefault();
                      updateBtn();
                    }} className='bg-[#0086ea] transition hover:bg-[#00A1C9]  px-4 py-1 text-[10.6px] tracking-wide text-[#fff]'>Update</button>
                    <button type="button" onClick={(e) => {
                      e.preventDefault();
                      leaveGroup();
                    }} className='bg-[#880808] hover:bg-[#A52A2A] transition delay-150 px-4 py-1 text-[10.6px] tracking-wide text-[#fff]'>Leave</button>
                  </div>
                </div>
              </div>
            </Box>
